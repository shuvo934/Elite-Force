package ttit.com.shuvo.eliteforce.attendance.att_report.model;
...
public class AttenReportList {
    ...
    public AttenReportList(String date, String status, String shift, String punchLoc, String inTime, String inStatus, String outTime, String outStatus,String attStatusColor,String inLat, String inLon, String outLat, String outLon, Blob blob, String  elr_id) {
        this.date = date;
        this.status = status;
        this.shift = shift;
